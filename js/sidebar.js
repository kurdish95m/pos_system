...
function getPageDetails() {
    ...
    const pages = {
		...
		'calculator.html': { title: 'الحاسبة', icon: 'fa-calculator' }
    };
...
<div id="sidebar" class="fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-[1050] transition-transform duration-300 translate-x-full overflow-y-auto" >
  ...
  <a href="calculator.html" class="flex items-center gap-4 px-4 py-3 font-medium text-gray-700 transition-all rounded-xl hover:bg-blue-50 hover:text-blue-600 group">
    <i class="fas fa-calculator w-6 text-center transition-transform group-hover:scale-110"></i>
    <span>الحاسبة</span>
</a>
